...
export default function Profile() {
        ...
        fetch(`${baseUrl.baseUrl}webapi/teachelogin`, requestOptions)
            ...
            .then(result => {
                ...
                if (result.status) {
                    ...
                    setZoomID(result.data.zoomid)
                    setZoomPass(result.data.zoompassword)
                }
                else {
    ...
    const updateProfile = () => {
        ...
        form.append("zoomid", ZoomID);
        form.append("zoompassword", ZoomPass);
                            ...
                            <div className="card-body">
                                ...
                                <div className="row">
                                    <div className="col-md-12 text-center">
                                        ...
                                        <label htmlFor="icon-button-file">
                                            ...
                                            >
                                                <img style={{ minWidth: "120px", maxWidth: "120px", borderRadius: "20px" }} src={SelectProfileImage ? SelectProfileImage : baseUrl.baseUrl + ProfileImage} className="upload_photo_main" alt=""/>
                                            </IconButton>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div className="row form-row">
                                    <div className="col-md-6 mt-3">
                                        ...
                                        <input value={Age} onChange={(e) => handleInputChange(e, setAge)} className="form-control" type="text" placeholder="Enter Your Age" />
                                    </div>
                                    <div className="col-md-6 mt-3">
                                ...
                                <div className="row form-row">
                                    <div className="col-md-6 mt-3 ">
                                        ...
                                        <input value={ZoomID} onChange={(e) => handleInputChange(e, setZoomID)} className="form-control" type="text" placeholder="Enter Your Age" />
                                    </div>
                                    <div className="col-md-6 mt-3">
                                        <label className="label25 text-left">Zoom Password*</label>
                                        <input value={ZoomPass} onChange={(e) => handleInputChange(e, setZoomPass)} className="form-control text-capitalize" type="text" placeholder="Write a short discription..." />
                                    </div>
                                </div>
