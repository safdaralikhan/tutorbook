...
export default function Forget() {
  ...
  const Forget = () => {
    ...
    if (Email == "") {
      ...
      formdata.append("sendstatus", 'student');
      ...
      fetch(`${baseUrl.baseUrl}webapi/forgettokenCheck`, requestOptions)
        ...
        .then(result => {
          ...
          if (result.status) {
            // <NewPassword id={Id}/>
            Router.push({
              pathname: '/student/auth/forgetpassword/newPassword',
              query: { id: Id }
          })
        ...
        <div className="row justify-content-lg-center justify-content-md-center">
          <div className="col-lg-12">
            <div className="main_logo26" id="logo">
              <Link href={"/student/auth/forgetpassword"} passHref><a href="#"><img src="/static/images/rev4-01.svg" width={"450px"} height={'120px'} alt="Tutor Learner" /></a></Link>
              <Link href={"/student/auth/forgetpassword"} passHref><a href="#"><img className="logo-inverse" src="/static/images/rev4-01.svg" width={"450px"} height={'120px'} alt="Tutor Learner" /></a></Link>
            </div>
          </div>
          <div className="col-lg-6 col-md-8">
            <div className="sign_form">
              ...
              <Link href={"/student/auth/login"} passHref><p className="mb-0 mt-30 sgntrm145">Go Back <a href="#">Sign In</a></p></Link>
            </div>
