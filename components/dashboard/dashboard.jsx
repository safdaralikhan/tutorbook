            ...
            <div className="row">
                <div className="col-xl-9 col-lg-8">
                        ...
                        <div className="la5lo1">
                            <div className="owl-carousel live_stream owl-theme">
                                ...
                                <div className="item">
                                    <div className="stream_1">
                                        <a href="live_output.html" className="stream_bg">
                                            <img src="static/images/left-imgs/img-4.jpg" alt="" />
                                            <h4>Zoena</h4>
                                            <p>live<span></span></p>
                                        </a>
                                    </div>
                                ...
                                <div className="item">
                                    <div className="stream_1">
                                        <a href="live_output.html" className="stream_bg">
                                            <img src="static/images/left-imgs/img-7.jpg" alt="" />
                                            <h4>Amritpal</h4>
                                            <p>live<span></span></p>
                                        </a>
                                    </div>
                        ...
                        <div className="la5lo1">
                            <div className="owl-carousel featured_courses owl-theme">
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="course_detail_view.html" className="fcrse_img">
                                            <img src="static/images/courses/img-1.jpg" alt="" />
                                        ...
                                        <div className="fcrse_content">
                                            ...
                                            <a href="course_detail_view.html" className="crse14s">Complete Python
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="course_detail_view.html" className="fcrse_img">
                                            <img src="static/images/courses/img-2.jpg" alt="" />
                                            <div className="course-overlay">
                                                <div className="badge_seller">Bestseller</div>
                                                <div className="crse_reviews">
                                                    <i className='uil uil-star'></i>4.5
                                        ...
                                        <div className="fcrse_content">
                                            ...
                                            <a href="course_detail_view.html" className="crse14s">The Complete
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="course_detail_view.html" className="fcrse_img">
                                            <img src="static/images/courses/img-3.jpg" alt="" />
                                            <div className="course-overlay">
                                                <div className="badge_seller">Bestseller</div>
                                                <div className="crse_reviews">
                                                    <i className='uil uil-star'></i>4.5
                                        ...
                                        <div className="fcrse_content">
                                            ...
                                            <a href="course_detail_view.html" className="crse14s">Beginning C++
                                                Programming - From Beginner to Beyond</a>
                                            <a href="#" className="crse-cate">Development | C++</a>
                                            <div className="auth1lnkprce">
                                                <p className="cr1fot">By <a href="#">Joginder Singh</a></p>
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="course_detail_view.html" className="fcrse_img">
                                            <img src="static/images/courses/img-4.jpg" alt="" />
                                            <div className="course-overlay">
                                                <div className="badge_seller">Bestseller</div>
                                                <div className="crse_reviews">
                                        ...
                                        <div className="fcrse_content">
                                            ...
                                            <a href="course_detail_view.html" className="crse14s">The Complete Digital
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="course_detail_view.html" className="fcrse_img">
                                            <img src="static/images/courses/img-5.jpg" alt="" />
                                            <div className="course-overlay">
                                                <div className="badge_seller">Bestseller</div>
                                                <div className="crse_reviews">
                                                    <i className='uil uil-star'></i>4.5
                                        ...
                                        <div className="fcrse_content">
                                            ...
                                            <a href="course_detail_view.html" className="crse14s">Microsoft Excel -
                                                Excel from Beginner to Advanced</a>
                                            <a href="#" className="crse-cate">Office Productivity | Excel</a>
                                            <div className="auth1lnkprce">
                                                <p className="cr1fot">By <a href="#">Rock William</a></p>
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="course_detail_view.html" className="fcrse_img">
                                            <img src="static/images/courses/img-6.jpg" alt="" />
                                            <div className="course-overlay">
                                                <div className="badge_seller">Bestseller</div>
                                                <div className="crse_reviews">
                                                    <i className='uil uil-star'></i>5.0
                                        ...
                                        <div className="fcrse_content">
                                            ...
                                            <a href="course_detail_view.html" className="crse14s">Angular 8 - The
                                                Complete Guide (2020 Edition)</a>
                                            <a href="#" className="crse-cate">Development | Angular</a>
                                            <div className="auth1lnkprce">
                                                <p className="cr1fot">By <a href="#">John Doe</a></p>
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="course_detail_view.html" className="fcrse_img">
                                            <img src="static/images/courses/img-7.jpg" alt="" />
                                            <div className="course-overlay">
                                                <div className="badge_seller">Bestseller</div>
                                                <div className="crse_reviews">
                                                    <i className='uil uil-star'></i>5.0
                                        ...
                                        <div className="fcrse_content">
                                            ...
                                            <a href="course_detail_view.html" className="crse14s">WordPress for
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="course_detail_view.html" className="fcrse_img">
                                            <img src="static/images/courses/img-8.jpg" alt="" />
                                            <div className="course-overlay">
                                                <div className="badge_seller">Bestseller</div>
                                                <div className="crse_reviews">
                                        ...
                                        <div className="fcrse_content">
                                            ...
                                            <a href="course_detail_view.html" className="crse14s">CSS - The Complete
                        ...
                        <div className="la5lo1">
                            <div className="owl-carousel featured_courses owl-theme">
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="course_detail_view.html" className="fcrse_img">
                                            <img src="static/images/courses/img-14.jpg" alt="" />
                                            <div className="course-overlay">
                                                <span className="play_btn1"><i className="uil uil-play"></i></span>
                                                <div className="crse_timer">
                                                    12 hours
                                        ...
                                        <div className="fcrse_content">
                                            ...
                                            <a href="course_detail_view.html" className="crse14s">Build Responsive Real
                                                World Websites with HTML5 and CSS3</a>
                                            <a href="#" className="crse-cate">Development | CSS</a>
                                            <div className="auth1lnkprce">
                                                <p className="cr1fot">By <a href="#">John Doe</a></p>
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="course_detail_view.html" className="fcrse_img">
                                            <img src="static/images/courses/img-11.jpg" alt="" />
                                            <div className="course-overlay">
                                                <span className="play_btn1"><i className="uil uil-play"></i></span>
                                                <div className="crse_timer">
                                                    28 hours
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="course_detail_view.html" className="fcrse_img">
                                            <img src="static/images/courses/img-18.jpg" alt="" />
                                            <div className="course-overlay">
                                                <span className="play_btn1"><i className="uil uil-play"></i></span>
                                                <div className="crse_timer">
                                                    15 hours
                                        ...
                                        <div className="fcrse_content">
                                            ...
                                            <a href="course_detail_view.html" className="crse14s">The Complete Front-End
                                                Web Development Course!</a>
                                            <a href="#" className="crse-cate">Development | Web Development</a>
                                            <div className="auth1lnkprce">
                                                <p className="cr1fot">By <a href="#">Joginder Singh</a></p>
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="course_detail_view.html" className="fcrse_img">
                                            <img src="static/images/courses/img-19.jpg" alt="" />
                                            <div className="course-overlay">
                                                <div className="crse_reviews">
                                                    <i className='uil uil-star'></i>5.0
                                                </div>
                                        ...
                                        <div className="fcrse_content">
                                            ...
                                            <a href="course_detail_view.html" className="crse14s">Ethical Hacking - Most
                                                Advanced Level Penetration Testing</a>
                                            <a href="#" className="crse-cate">IT &amp; Software | Ethical Hacking</a>
                                            <div className="auth1lnkprce">
                                                <p className="cr1fot">By <a href="#">Poonam Verma</a></p>
                                                <div className="prce142">$10</div>
                                                <button className="shrt-cart-btn" title="cart"><i
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="#" className="fcrse_img">
                                            <img src="static/images/courses/img-12.jpg" alt="" />
                                            <div className="course-overlay">
                                                <div className="crse_reviews">
                                                    <i className='uil uil-star'></i>3.5
                                                </div>
                                                <span className="play_btn1"><i className="uil uil-play"></i></span>
                                                <div className="crse_timer">
                                                    28 hours
                                        ...
                                        <div className="fcrse_content">
                                            ...
                                            <a href="course_detail_view.html" className="crse14s">Advanced CSS and Sass:
                                                Flexbox, Grid, Animations and More!</a>
                                            <a href="#" className="crse-cate">Development | Sass</a>
                                            <div className="auth1lnkprce">
                                                <p className="cr1fot">By <a href="#">Rock William</a></p>
                                                <div className="prce142">$6</div>
                                                <button className="shrt-cart-btn" title="cart"><i
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="#" className="fcrse_img">
                                            <img src="static/images/courses/img-13.jpg" alt="" />
                                            <div className="course-overlay">
                                                <span className="play_btn1"><i className="uil uil-play"></i></span>
                                                <div className="crse_timer">
                                                    30 hours
                                        ...
                                        <div className="fcrse_content">
                                            ...
                                            <a href="course_detail_view.html" className="crse14s">The Complete Node.js
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="#" className="fcrse_img">
                                            <img src="static/images/courses/img-20.jpg" alt="" />
                                            <div className="course-overlay">
                                                <div className="crse_reviews">
                                                    <i className='uil uil-star'></i>5.0
                                                </div>
                                        ...
                                        <div className="fcrse_content">
                                            ...
                                            <a href="course_detail_view.html" className="crse14s">WordPress Development
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <a href="course_detail_view.html" className="fcrse_img">
                                            <img src="static/images/courses/img-16.jpg" alt="" />
                                            <div className="course-overlay">
                                                <span className="play_btn1"><i className="uil uil-play"></i></span>
                                                <div className="crse_timer">
                                                    22 hours
                                        ...
                                        <div className="fcrse_content">
                                            ...
                                            <a href="course_detail_view.html" className="crse14s">Vue JS 2 - The
                    ...
                    <div className="section3125 mt-50">
                        ...
                        <a href="all_instructor.html" className="see150">See all</a>
                        <div className="la5lo1">
                            <div className="owl-carousel top_instrutors owl-theme">
                                    ...
                                    <div className="fcrse_1 mb-20">
                                        <div className="tutor_img">
                                            <a href="instructor_profile_view.html"><img
                                                src="static/images/left-imgs/img-1.jpg" alt="" /></a>
                                        </div>
                                        <div className="tutor_content_dt">
                                            <div className="tutor150">
                                                <a href="instructor_profile_view.html" className="tutor_name">John
                                                    Doe</a>
                                            ...
                                            <ul className="tutor_social_links">
                                                ...
                                                <li><a href="#" className="ln"><i className="fab fa-linkedin-in"></i></a>
                                                </li>
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <div className="tutor_img">
                                            <a href="instructor_profile_view.html"><img
                                                src="static/images/left-imgs/img-2.jpg" alt="" /></a>
                                        </div>
                                        <div className="tutor_content_dt">
                                            <div className="tutor150">
                                                <a href="instructor_profile_view.html" className="tutor_name">Kerstin
                                                    Cable</a>
                                                <div className="mef78" title="Verify">
                                                    <i className="uil uil-check-circle"></i>
                                                </div>
                                            </div>
                                            <div className="tutor_cate">Language Learning Coach, Writer, Online Tutor
                                            </div>
                                            <ul className="tutor_social_links">
                                                <li><a href="#" className="fb"><i className="fab fa-facebook-f"></i></a>
                                                </li>
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <div className="tutor_img">
                                            <a href="instructor_profile_view.html"><img
                                                src="static/images/left-imgs/img-3.jpg" alt="" /></a>
                                        </div>
                                        <div className="tutor_content_dt">
                                            <div className="tutor150">
                                                <a href="instructor_profile_view.html" className="tutor_name">Jose
                                                    Portilla</a>
                                                <div className="mef78" title="Verify">
                                                    <i className="uil uil-check-circle"></i>
                                                </div>
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <div className="tutor_img">
                                            <a href="instructor_profile_view.html"><img
                                                src="static/images/left-imgs/img-4.jpg" alt="" /></a>
                                        </div>
                                        <div className="tutor_content_dt">
                                            <div className="tutor150">
                                                <a href="instructor_profile_view.html" className="tutor_name">Farhat
                                                    Amin</a>
                                                <div className="mef78" title="Verify">
                                                    <i className="uil uil-check-circle"></i>
                                                </div>
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <div className="tutor_img">
                                            <a href="instructor_profile_view.html"><img
                                                src="static/images/left-imgs/img-5.jpg" alt="" /></a>
                                        </div>
                                        <div className="tutor_content_dt">
                                            <div className="tutor150">
                                                <a href="instructor_profile_view.html" className="tutor_name">Kyle
                                                    Pew</a>
                                                <div className="mef78" title="Verify">
                                                    <i className="uil uil-check-circle"></i>
                                                </div>
                                            </div>
                                            <div className="tutor_cate">Microsoft Certified Trainer - 380,000+ Udemy
                                                Students</div>
                                            <ul className="tutor_social_links">
                                                <li><a href="#" className="fb"><i className="fab fa-facebook-f"></i></a>
                                                </li>
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <div className="tutor_img">
                                            <a href="instructor_profile_view.html"><img
                                                src="static/images/left-imgs/img-7.jpg" alt="" /></a>
                                        </div>
                                        <div className="tutor_content_dt">
                                            <div className="tutor150">
                                                <a href="instructor_profile_view.html" className="tutor_name">Jaysen
                                                    Batchelor</a>
                                                <div className="mef78" title="Verify">
                                                    <i className="uil uil-check-circle"></i>
                                                </div>
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <div className="tutor_img">
                                            <a href="instructor_profile_view.html"><img
                                                src="static/images/left-imgs/img-8.jpg" alt="" /></a>
                                        </div>
                                        <div className="tutor_content_dt">
                                            <div className="tutor150">
                                                <a href="instructor_profile_view.html" className="tutor_name">Quinton
                                                    Batchelor</a>
                                                <div className="mef78" title="Verify">
                                                    <i className="uil uil-check-circle"></i>
                                                </div>
                                ...
                                <div className="item">
                                    <div className="fcrse_1 mb-20">
                                        <div className="tutor_img">
                                            <a href="instructor_profile_view.html"><img
                                                src="static/images/left-imgs/img-6.jpg" alt="" /></a>
                                        </div>
                                        <div className="tutor_content_dt">
                                            <div className="tutor150">
                                                <a href="instructor_profile_view.html" className="tutor_name">Eli
                                                    Natoli</a>
                                                <div className="mef78" title="Verify">
                                                    <i className="uil uil-check-circle"></i>
                                                </div>
                                            </div>
                                            <div className="tutor_cate">Entrepreneur - Passionate Tutor</div>
                                            <ul className="tutor_social_links">
                                                <li><a href="#" className="fb"><i className="fab fa-facebook-f"></i></a>
                                                </li>
                                                <li><a href="#" className="tw"><i className="fab fa-twitter"></i></a></li>
                ...
                <div className="col-xl-3 col-lg-4">
                    <div className="right_side">
                        <div className="fcrse_2 mb-30">
                            <div className="tutor_img">
                                <a href="my_instructor_profile_view.html"><img src="static/images/left-imgs/img-10.jpg"
                                    alt="" /></a>
                            </div>
                            <div className="tutor_content_dt">
                                <div className="tutor150">
                                    <a href="my_instructor_profile_view.html" className="tutor_name">Joginder Singh</a>
                                    <div className="mef78" title="Verify">
                                        <i className="uil uil-check-circle"></i>
                                    </div>
                                </div>
                                <div className="tutor_cate">Web Developer, Designer, and Tutor</div>
                                <ul className="tutor_social_links">
                                ...
                                <a href="my_instructor_profile_view.html" className="prfle12link">Go To Profile</a>
                            </div>
                        </div>
                        <div className="fcrse_3">
                            ...
                            <div className="live_text">
                                <div className="live_icon"><i className="uil uil-kayak"></i></div>
                        ...
                        <div className="fcrse_3">
                            ...
                            <ul className="allcate15">
                                <li><a href="#" className="ct_item"><i className='uil uil-arrow'></i>Development</a></li>
                                <li><a href="#" className="ct_item"><i className='uil uil-graph-bar'></i>Business</a></li>
                                <li><a href="#" className="ct_item"><i className='uil uil-monitor'></i>IT and Software</a>
                                </li>
                                <li><a href="#" className="ct_item"><i className='uil uil-ruler'></i>Design</a></li>
                                <li><a href="#" className="ct_item"><i className='uil uil-chart-line'></i>Marketing</a></li>
                                <li><a href="#" className="ct_item"><i className='uil uil-book-open'></i>Personal
                                    Development</a></li>
                                <li><a href="#" className="ct_item"><i className='uil uil-camera'></i>Photography</a></li>
                                <li><a href="#" className="ct_item"><i className='uil uil-music'></i>Music</a></li>
                            </ul>
                        </div>
                        ...
                        <div className="la5lo1">
                            <div className="owl-carousel Student_says owl-theme">
                                ...
                                <div className="item">
                                    <div className="fcrse_4 mb-20">
                                        <div className="say_content">
                                            <p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit. className
