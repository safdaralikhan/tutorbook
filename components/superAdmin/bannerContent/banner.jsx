                ...
                <div className="row">
                    <div className="col-xl-12 col-lg-8">
                        <div className="section3125">
                            <h4 className="item_title">Banner Content</h4>
                            ...
                            <div className="la5lo1">
                                <div className="row">
                                    <div className="col-md-12 item">
                                        <MaterialTable
                                            columns={[
                                                {title: 'Banner Image', field: 'bannerImg', render: item => <img src={baseUrl.baseUrl +'media/' +item.bannerImg} alt="" border="3" height="50" width="40" style={{ borderRadius: '50%'}} />},
                ...
                <ModalBody className='text-left'>
                    <form>
                        <div className="row form-row">
                            <div className="col-12 col-sm-12">
                                <div className="form-group">
                                    <label className="label25 text-left">Banner Tittle*</label>
                                    {/* <label>Course Tittle</label> */}
                                    <input value={BannerTitle} type="text" onChange={(e) => handleInputChange(e, setBannerTitle)} className="form-control" placeholder='Write Banner Tittle' />
                                </div>
                            </div>
                        ...
                        <div className="row text-center justify-content-end">
                            ...
                            <button type="button" onClick={() => addBanner(Token)} className="col-2 main-btn" disabled={Disable}>Add</button>
                        </div>
                        ...
                        <div className="row form-row">
                            <div className="col-12 col-sm-12">
                                <div className="form-group">
                                    <label className="label25 text-left">Banner Tittle*</label>
                                    {/* <label>Course Tittle</label> */}
                                    <input type="text" value={BannerTitle} onChange={(e) => handleInputChange(e, setBannerTitle)} className="form-control" placeholder='Write Banner Tittle' />
                                </div>
                            </div>
