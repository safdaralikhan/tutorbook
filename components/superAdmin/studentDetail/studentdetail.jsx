...
export default function StudentDetail() {
    ...
    const getPackages = (token) => {
        ...
        fetch(`${baseUrl.baseUrl}webapi/studentDetails?all=${true}`, requestOptions)
    ...
    const deleteStudent = (studentId) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // setLoader(true);
                fetch(`${baseUrl.baseUrl}webapi/deleteStudent?studentid=${studentId}`, requestOptions)
                    .then(response => response.json())
                    .then(result => {
                        setLoader(false);
                        console.log(result);
                ...
                <div className="row">
                    <div className="col-xl-12 col-lg-8">
                        <div className="section3125">
                            <h4 className="item_title">Student Detail</h4>
                                    ...
                                    <div className="col-md-12 item">
                                        <MaterialTable
                                            ...
                                            actions={[
                                                ...
                                                rowData => ({
                                                    icon: 'visibility',
                                                    tooltip: 'subscription detail',
                                                    onClick: (event, rowData) => Router.push({ pathname: '/superAdmin/studentSubscriptionDetail', query: { user_Id: rowData.User_Signup_id } }),
                                                }),
                                                rowData => ({
                                                    icon: 'delete',
                                                    tooltip: 'delete',
                                                    onClick: (event, rowData) => deleteStudent(rowData.User_Signup_id),
                                                })
                                            ]}
                                            data={Packages}
                                            options={{
                        ...
                        <div className="row form-row">
                            ...
                            <div className="col-12 col-sm-6">
                                <div className="form-group">
                                    ...
                                    {PackageType == "Private" ?
                                        <input type="number" readOnly value={1} className="form-control" placeholder='Write number of people' />
                                        :
                                        <input type="number" value={5} readOnly className="form-control" placeholder='Write number of people' />
                                    }
                                </div>
                            </div>
                        </div>
