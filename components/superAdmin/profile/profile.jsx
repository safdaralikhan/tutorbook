                            ...
                            <div className="card-body">
                                ...
                                <div className="row form-row">
                                    <div className="col-md-6 mt-3 form-group">
                                        ...
                                        <input value={FirstName} onChange={(e) => handleInputChange(e, setFirstName)} className="form-control" type="text" placeholder="Enter Your First Name" />
                                    </div>
                                    <div className="col-md-6 mt-3">
                                        <label className="label25 text-left">Last Name*</label>
                                        <input value={LastName} onChange={(e) => handleInputChange(e, setLastName)} className="form-control" type="text" placeholder="Enter Your Last Name" />
                                    </div>
                                </div>
                                <div className="row form-row">
                                    <div className="col-md-6 mt-3 form-group">
                                    ...
                                    <div className="col-md-6 mt-3">
                                        <label className="label25 text-left">Username*</label>
                                        <input value={Username} onChange={(e) => handleInputChange(e, setUsername)} className="form-control" type="text" placeholder="Enter Your Contact" />
                                    </div>
                                </div>
                                <div className="row form-row">
