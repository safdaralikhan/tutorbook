                    ...
                    <div className="col-lg-3 col-md-3 col-sm-6">
                        <div className="item_f3">
                            ...
                            <div className="lng_btn">
                                <div className="ui language bottom right pointing dropdown floating" id="languages"
                                    data-content="Select Language">
                                    <a href="#"><i className='uil uil-globe lft'></i>Language<i
                                            className='uil uil-angle-down rgt'></i></a>
                                    <div className="menu">
                                        <div className="scrolling menu">
                                            ...
                                            <div className="item" data-percent="54" data-value="zh_TW"
                                            ...
                                            <div className="item" data-percent="19" data-value="pt_BR"
                                                data-english="Portuguese">
                                                <span className="description">Português(BR)</span>
                                                Portuguese
                                            </div>
                                            <div className="item" data-percent="17" data-value="id"
                                                data-english="Indonesian">
                                                <span className="description">Indonesian</span>
                                                Indonesian
                                            </div>
                                            <div className="item" data-percent="12" data-value="lt"
                                            ...
                                            <div className="item" data-percent="6" data-value="vi"
