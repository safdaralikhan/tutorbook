...
export default function Header(props) {
    ...
    useEffect(() => {
        ...
        // getProfile(localStorage.getItem("superAdminToken"))
        getAuth();
    }, [])
    ...
    const getProfile = (token) => {
        ...
        fetch(`${baseUrl.baseUrl}webapi/superadminProfile`, requestOptions)
    ...
    const forgot = () => {
        if (NewPassword == ConfirmNewPassword) {
            ...
            fetch(`${baseUrl.baseUrl}webapi/changepassword`, requestOptions)
                .then(response => response.json())
                .then(result => {
                    setLoader(false);
                    // console.log(result);
        ...
        <>
            ...
            <header className="header clearfix">
                ...
                <div className="main_logo" id="logo">
                    <Link href={"/superAdmin/dashboard"}><a href="#"><img src="/static/images/rev4-01.svg" width={"190px"} alt="" /></a></Link>
                    <Link href={"/superAdmin/dashboard"}><a href="#"><img className="logo-inverse" src="/static/images/rev4-01.svg" width={"190px"} alt="" /></a></Link>
                </div>
                    ...
                    <ul>
                        ...
                        <li onClick={() => profiledropdown("profile")} className={profileDrop == "profile" ? "ui dropdown active visible" : "ui dropdown"}>
                            <a href="#" className="opts_account" title="Account Information">
                                <img src={ProfieData.profile != "" ? baseUrl.baseUrl + ProfieData.profile : "/static/images/hd_dp.jpg"} alt="" />
                            </a>
                            <div className={profileDrop == "profile" ? "menu dropdown_account left transition visible d-block" : "menu dropdown_account"} >
                                <div className="channel_my">
                                    <div className="profile_link">
                                        ...
                                        <div className="pd_content">
                                            <div className="rhte85">
                                                <h6 className="text-capitalize">{ProfieData.fname + " " + ProfieData.lname}</h6>
                                    ...
                                    <Link href={"/superAdmin/profile"}><a href="#" className="dp_link_12">View Profile</a></Link>
                                </div>
                                ...
                                <a href="#" onClick={() => { toggle2(), setmodaltitle("Change Password") }} className="item channel_item">Change Password</a>
                                ...
                                <a href="#" onClick={logout} className="item channel_item">Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <nav className={Sidebar == "largeScreen" ? "vertical_nav vertical_nav__minify" : (Sidebar == "smallScreen" ? "vertical_nav vertical_nav__opened" : "vertical_nav")}>
                        ...
                        <ul>
                            ...
                            <li className="menu--item">
                                <Link href={"/superAdmin/packages"}>
                                    <a href="#" className={props.active == "packages" ? "menu--link active" : "menu--link"} title="Packages">
                            ...
                            <li className="menu--item">
                                <Link href={"/superAdmin/teachers"}>
                                    <a href="#" className={props.active == "teacher" ? "menu--link active" : "menu--link"} title="Teacher">
                                        <i className="fas fa-chalkboard-teacher menu--icon d-flex justify-content-center align-items-center"></i>
                                        {/* <i className="uil uil-heart-alt menu--icon"></i> */}
                                        <span className="menu--label">Tutor</span>
                                    </a>
                                </Link>
                            </li>
                            <li className="menu--item">
                                <Link href={"/superAdmin/rewards"}>
                                    <a href="#" className={props.active == "rewards" ? "menu--link active" : "menu--link"} title="Rewards">
                                        <i className="fas fa-award menu--icon d-flex justify-content-center align-items-center"></i>
                                        {/* <i className="uil uil-heart-alt menu--icon"></i> */}
                            ...
                            <li className="menu--item">
                                <Link href={"/superAdmin/studentDetail"}>
                                    <a href="#" className={props.active == "student" ? "menu--link active" : "menu--link"} title="Student">
                                        <i className="fas fa-user-graduate menu--icon d-flex justify-content-center align-items-center"></i>
                                        {/* <i className="uil uil-heart-alt menu--icon"></i> */}
                            ...
                            <li className="menu--item">
                                <Link href={"/superAdmin/bankDetail"}>
                                    <a href="#" className={props.active == "bank" ? "menu--link active" : "menu--link"} title="Bank Detail">
                                        <i className="fas fa-money-check menu--icon d-flex justify-content-center align-items-center"></i>
                                        {/* <i className="uil uil-heart-alt menu--icon"></i> */}
                                        <span className="menu--label">Bank Detail</span>
                                    </a>
                                </Link>
                            </li>
                            <li className="menu--item">
                                <Link href={"/superAdmin/aboutContent"}>
                                    <a href="#" className={props.active == "about" ? "menu--link active" : "menu--link"} title="About Content">
                                        <i className="fas fa-info-circle menu--icon d-flex justify-content-center align-items-center"></i>
                                        {/* <i className="uil uil-heart-alt menu--icon"></i> */}
                                        <span className="menu--label">About Content</span>
                                    </a>
                                </Link>
                            </li>
                            <li className="menu--item">
                                <Link href={"/superAdmin/contactUsContent"}>
                                    <a href="#" className={props.active == "contact" ? "menu--link active" : "menu--link"} title="Contact Content">
                                        <i className="fas fa-address-book menu--icon d-flex justify-content-center align-items-center"></i>
                                        {/* <i className="uil uil-heart-alt menu--icon"></i> */}
                                        <span className="menu--label">Contact Content</span>
                                    </a>
                                </Link>
                            </li>
                            <li className="menu--item">
                                <Link href={"/superAdmin/bannerContent"}>
                                    <a href="#" className={props.active == "banner" ? "menu--link active" : "menu--link"} title="Contact Content">
                                        <i className="fa fa-file-image menu--icon d-flex justify-content-center align-items-center"></i>
                                        {/* <i className="uil uil-heart-alt menu--icon"></i> */}
                                        <span className="menu--label">Banner Content</span>
                                    </a>
                                </Link>
                            </li>
                            <li className="menu--item">
                                <Link href={"/superAdmin/backgroundImages"}>
                                    <a href="#" className={props.active == "background" ? "menu--link active" : "menu--link"} title="Contact Content">
                                        <i className="fas fa-image menu--icon d-flex justify-content-center align-items-center"></i>
                                        {/* <i className="uil uil-heart-alt menu--icon"></i> */}
                                        <span className="menu--label">Background Images</span>
                                    </a>
                                </Link>
                            </li>
                            <li className="menu--item">
                                <Link href={"/superAdmin/team"}>
                                    <a href="#" className={props.active == "team" ? "menu--link active" : "menu--link"} title="Schedule">
                                        <i className="fas fa-users menu--icon d-flex justify-content-center align-items-center"></i>
                                        <span className="menu--label">Team</span>
                                    </a>
                                </Link>
                            </li>
                            <li className="menu--item">
                                <Link href={"/superAdmin/sessionDescription"}>
                                    <a href="#" className={props.active == "session" ? "menu--link active" : "menu--link"} title="Schedule">
                                        <i className="fas fa-calendar menu--icon d-flex justify-content-center align-items-center"></i>
                                        <span className="menu--label">Session Description</span>
                                    </a>
                                </Link>
                            </li>
                        ...
                        <ul>
                            <li className="menu--item">
                                <Link href={"/superAdmin/profile"}>
                                    <a href="#" className={props.active == "profile" ? "menu--link active" : "menu--link"} title="Profile">
                ...
                <ModalBody className='text-left'>
                    <form>
                        ...
                        <div className="row text-center justify-content-end">
                            ...
                            <button type="button" onClick={() => forgot()} className="col-3 main-btn" disabled={ConfirmNewPassword == "" ? true : false}>Update</button>
                        </div>
