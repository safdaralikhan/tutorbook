...
export default function Header(props) {
    ...
    useEffect(() => {
        ...
        // getProfile(localStorage.getItem("teacherToken"))
        getAuth()
    }, [])
    ...
    const getProfile = (token) => {
        ...
        fetch(`${baseUrl.baseUrl}webapi/teachelogin`, requestOptions)
    ...
    const forgot = () => {
        if (NewPassword == ConfirmNewPassword) {
            ...
            fetch(`${baseUrl.baseUrl}webapi/teacherchangepassword`, requestOptions)
                .then(response => response.json())
                .then(result => {
                    setLoader(false);
                    // console.log(result);
        ...
        <>
            ...
            <header className="header clearfix">
                ...
                <div className="main_logo" id="logo">
                    ...
                    <Link href={"/teacher/dashboard"}><a href="#"><img src="/static/images/rev4-01.svg" width={"190px"} alt="" /></a></Link>
                    <Link href={"/teacher/dashboard"}><a href="#"><img className="logo-inverse" src="/static/images/rev4-01.svg" width={"190px"} alt="" /></a></Link>
                </div>
                        ...
                        <li onClick={() => profiledropdown("profile")} className={profileDrop == "profile" ? "ui dropdown active visible" : "ui dropdown"}>
                            ...
                            <div className={profileDrop == "profile" ? "menu dropdown_account left transition visible d-block" : "menu dropdown_account"} >
                                <div className="channel_my">
                                    ...
                                    <Link href={"/teacher/profile"}><a href="#" className="dp_link_12">View Profile</a></Link>
                                </div>
                ...
                <div className="left_section menu_left" id="js-menu">
                    <div className="left_section">
                        <ul>
                            ...
                            <li className="menu--item">
                                <Link href={"/teacher/currentAppointment"}>
                                    <a href="#" className={props.active == "currentAppointment" ?"menu--link active":"menu--link"} title="Current Appointment">
                                        <i className="fas fa-calendar-check menu--icon d-flex justify-content-center align-items-center"></i>
                                        <span className="menu--label">Appointment</span>
                                    </a>
                                </Link>
                            </li>
                            ...
                            {/* <li className="menu--item">
                                <a href="explore.html" className="menu--link" title="Explore">
                                    ...
                                    <span className="menu--label">Tutors</span>
                                </a>
                             </Link>
                            </li>
